...
import { Feather, Ionicons, MaterialIcons, AntDesign, FontAwesome } from '@expo/vector-icons';

const ProfileScreen = () => {
  // Menu items with icons and labels
  const menuItems = [
    { icon: <Feather name="edit-2" size={20} color="#2D6A4F" />, label: "Edit Profile Name", hasArrow: true },
    { icon: <Feather name="lock" size={20} color="#2D6A4F" />, label: "Change Password", hasArrow: true },
    { icon: <Feather name="mail" size={20} color="#2D6A4F" />, label: "Change Email Address", hasArrow: true },
    { icon: <Feather name="settings" size={20} color="#2D6A4F" />, label: "Settings", hasArrow: true },
